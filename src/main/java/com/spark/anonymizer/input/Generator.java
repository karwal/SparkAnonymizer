package com.spark.anonymizer.input;
...
public class Generator {
    ...
    private List<String> referenceStreetTypes;
    private List<String> referenceStreetNames;
    ...
    private Generator() {
        ...
        referenceStreetTypes = readFile("src/main/resources/ReferenceStreetTypes.txt");
        referenceStreetNames = readFile("src/main/resources/ReferenceStreetNames.txt");
        referenceSuburbs = readFile("src/main/resources/ReferenceSuburbs.txt");
        referenceStates = readFile("src/main/resources/ReferenceStates.txt");
    }
